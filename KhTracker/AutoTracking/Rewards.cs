...
namespace KhTracker
{
    class Rewards
    {
        ...
        public void ReadRewards()
        {
            ...
            // if shield
            ReadReward(0x01D0B6C2, 2, shieldChecks, 2);
            ReadReward(0x01D0B6E2, 2, shieldChecks, 4);
            ReadReward(0x01D0B712, 2, shieldChecks, 7);
            ReadReward(0x01D0B732, 2, shieldChecks, 9);
            ReadReward(0x01D0B742, 2, shieldChecks, 10);
            ReadReward(0x01D0B762, 2, shieldChecks, 12);
            ReadReward(0x01D0B782, 2, shieldChecks, 14);
            ReadReward(0x01D0B792, 2, shieldChecks, 15);
            ReadReward(0x01D0B7B2, 2, shieldChecks, 17);
            ReadReward(0x01D0B7E2, 2, shieldChecks, 20);
            ReadReward(0x01D0B812, 2, shieldChecks, 23);
            ReadReward(0x01D0B832, 2, shieldChecks, 25);
            ReadReward(0x01D0B862, 2, shieldChecks, 28);
            ReadReward(0x01D0B882, 2, shieldChecks, 30);
            ReadReward(0x01D0B892, 2, shieldChecks, 31); // 99
            ReadReward(0x01D0B8A2, 2, shieldChecks, 32);
            ReadReward(0x01D0B8B2, 2, shieldChecks, 33); // 99
            ReadReward(0x01D0B8C2, 2, shieldChecks, 34);
            ReadReward(0x01D0B8E2, 2, shieldChecks, 36);
            ReadReward(0x01D0B912, 2, shieldChecks, 39);
            ReadReward(0x01D0B932, 2, shieldChecks, 41);
            ReadReward(0x01D0B962, 2, shieldChecks, 44);
            ReadReward(0x01D0B982, 2, shieldChecks, 46);
            ReadReward(0x01D0B992, 2, shieldChecks, 47); // 99
            ReadReward(0x01D0B9A2, 2, shieldChecks, 48);
            ReadReward(0x01D0B9B2, 2, shieldChecks, 49); // 99
            ReadReward(0x01D0B9C2, 2, shieldChecks, 50);
            ReadReward(0x01D0B9F2, 2, shieldChecks, 53); // 99
            ReadReward(0x01D0BA52, 2, shieldChecks, 59); // 99
            ReadReward(0x01D0BAB2, 2, shieldChecks, 65); // 99
            ReadReward(0x01D0BB32, 2, shieldChecks, 73); // 99
            ReadReward(0x01D0BBF2, 2, shieldChecks, 85); // 99
            ReadReward(0x01D0BCD2, 2, shieldChecks, 99); // 99

            // if staff
            ReadReward(0x01D0B6C4, 2, staffChecks, 2);
            ReadReward(0x01D0B6E4, 2, staffChecks, 4);
            ReadReward(0x01D0B714, 2, staffChecks, 7);
            ReadReward(0x01D0B734, 2, staffChecks, 9);
            ReadReward(0x01D0B744, 2, staffChecks, 10);
            ReadReward(0x01D0B764, 2, staffChecks, 12);
            ReadReward(0x01D0B784, 2, staffChecks, 14);
            ReadReward(0x01D0B794, 2, staffChecks, 15);
            ReadReward(0x01D0B7B4, 2, staffChecks, 17);
            ReadReward(0x01D0B7E4, 2, staffChecks, 20);
            ReadReward(0x01D0B814, 2, staffChecks, 23);
            ReadReward(0x01D0B834, 2, staffChecks, 25);
            ReadReward(0x01D0B864, 2, staffChecks, 28);
            ReadReward(0x01D0B884, 2, staffChecks, 30);
            ReadReward(0x01D0B894, 2, staffChecks, 31); // 99
            ReadReward(0x01D0B8A4, 2, staffChecks, 32);
            ReadReward(0x01D0B8B4, 2, staffChecks, 33); // 99
            ReadReward(0x01D0B8C4, 2, staffChecks, 34);
            ReadReward(0x01D0B8E4, 2, staffChecks, 36);
            ReadReward(0x01D0B914, 2, staffChecks, 39);
            ReadReward(0x01D0B934, 2, staffChecks, 41);
            ReadReward(0x01D0B964, 2, staffChecks, 44);
            ReadReward(0x01D0B984, 2, staffChecks, 46);
            ReadReward(0x01D0B994, 2, staffChecks, 47); // 99
            ReadReward(0x01D0B9A4, 2, staffChecks, 48);
            ReadReward(0x01D0B9B4, 2, staffChecks, 49); // 99
            ReadReward(0x01D0B9C4, 2, staffChecks, 50);
            ReadReward(0x01D0B9F4, 2, staffChecks, 53); // 99
            ReadReward(0x01D0BA54, 2, staffChecks, 59); // 99
            ReadReward(0x01D0BAB4, 2, staffChecks, 65); // 99
            ReadReward(0x01D0BB34, 2, staffChecks, 73); // 99
            ReadReward(0x01D0BBF4, 2, staffChecks, 85); // 99
            ReadReward(0x01D0BCD4, 2, staffChecks, 99); // 99
